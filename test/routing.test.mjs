...
test("router rewrites gateway errors to name the failing provider", async () => {
  ...
  try {
    ...
    assert.equal(
      ...
      "Something is wrong at opencode: Grok 4.5 is unavailable right now. Retry in a few minutes or switch models. (HTTP 503: Upstream request failed: Endpoint is unavailable.)",
    );
